 ...
 * A flashcard is considered unique by comparing using {@code FlashCard#isSamePerson(FlashCard)}.
 * As such, adding and updating of persons uses FlashCard#isSamePerson(FlashCard) for equality so as to
