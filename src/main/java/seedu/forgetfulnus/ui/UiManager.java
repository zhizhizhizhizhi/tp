...
import seedu.forgetfulnus.MainApp;
...
public class UiManager implements Ui {
    ...
    private static final String ICON_APPLICATION = "/images/glossary.png";
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            showFatalErrorDialogAndShutdown("Fatal error during initialising", e);
        }
    }
